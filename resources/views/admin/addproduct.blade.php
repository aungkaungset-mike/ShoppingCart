              ...
              {{-- <form id="quickForm"> --}}
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('product_name', '',  ['placeholder' => 'Enter product name','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                  </div>
                  <div class="form-group">
                    ...
                    {{Form::text('product_price', '',  ['placeholder' => 'Enter product price','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                  </div>
                  <div class="form-group">
