    			...
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
						...
						@foreach ($categories as $category)
    						<li><a href="{{url('/viewproductbycategory/'.$category->category_name)}}" class="{{request()->is('viewproductbycategory/'.$category->category_name) ? 'active' : ''}}">{{$category->category_name}}</a></li>  							
						@endforeach
